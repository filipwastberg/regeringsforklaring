...
## Bakgrund
Analytikern Filip Wästberg från Ferrologic Analytics har analyserat analyserat alla regeringsförklaringar från 1976 fram till idag. Den första regeringsförklaringen som inte hölls av kungen var Torbjörn Fälldin 1976.
...
ggsave("figure/vanligaste_ord_totalt.pdf", width = 10)
```
...
ggsave("figure/antal_ord_per_statsminister.pdf", width = 10, height = 8)
```
...
ggsave("figure/sl_antal_ord.pdf", width = 10, height = 8)
```
...
ggsave("figure/antal_ord_totalt_over_tid.pdf", width = 10)
```
...
ggsave("figure/sl_over_tid.pdf", width = 10)
```
...
ggsave("figure/medelvarde_antal_ord.pdf", width = 10)
```
...
ggsave("figure/sl_viktigaste_ord.pdf", width = 10, height = 8)
```
...
#ggsave("figure/sl_relation_mellan_ord.pdf", width = 10)
```
